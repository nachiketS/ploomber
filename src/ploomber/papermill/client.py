...
from ploomber.papermill.nbclient import PloomberNotebookClient


# NOTE: this was adapted from papermill's source code
class PapermillPloomberNotebookClient(PloomberNotebookClient):
    """
    ...
    def log_output_message(self, output):
        ...
        elif self.log_output and ("data" in output
    ...
    def process_message(self, *arg, **kwargs):
        ...
        if output and (self.log_output or self.stderr_file
                       or self.stdout_file):
